...
import torch
from e2m_module import BiEncoder
import argparse
import numpy as np
import os
import random
...
from Data.utils import Logger, strtime
from Data.e2m_data import extractor_dataloader, extractor_getloaders, \
...
def load_model(is_init, config_path, model_path, device, type_loss,
    ...
    if is_init:
        ...
        model = BiEncoder(ctxt_bert, cand_bert, type_loss)
    else:
        model = BiEncoder(ctxt_bert, cand_bert, type_loss)
...
def main(args):
    ...
    samples_train, samples_val, samples_test, entities = \
        extractor_dataloader(args.data_dir, args.kb_dir)
    ...
    train_men_loader, val_men_loader, test_men_loader, entity_loader = \
        extractor_getloaders(samples_train, samples_val, samples_test, entities,
