...
from Data.e2m_data import matcher_dataloader, matcher_getloaders, get_golds, \
     get_results_doc, save_results
from Data.utils import Logger, compute_strong_micro_results, strtime
from e2m_module import Matcher, get_predicts, prune_predicts
from instance_extractor import configure_optimizer, configure_optimizer_simple, \
     set_seeds
...
def load_model(is_init, model_path, type_encoder, device, type_span_loss,
    ...
    if is_init:
        ...
        model = Matcher(encoder, type_span_loss, do_rerank, type_rank_loss,
...
def main(args):
    ...
    data = matcher_dataloader(args.data_dir, args.kb_dir)
    ...
    model.to(device)
    loader_train, loader_dev, loader_test = matcher_getloaders(tokenizer, data, args.L,
                                                               args.C, args.C_val,
                                                               args.B, args.val_bsz,
                                                               args.add_topic,
                                                               args.use_title)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--E2M', type=int, default=16,
